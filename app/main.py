...
from app.conversation.manager import Conversation, ConversationManagerAPI, ChatMessage, ChatRequest, ChatResponse
...
def chat(req: ChatRequest):
    ...
    history = conversation_manager.get_messages(cid)
